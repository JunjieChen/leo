...
const char *program_name;
 ...
 _Bool include_idle = 1;


 _Bool include_heading = 1;


 _Bool include_fullname = 1;


 _Bool include_project = 1;


 _Bool include_plan = 1;



 _Bool include_home_and_shell = 1;


 _Bool do_short_format = 1;



 _Bool include_where = 1;
...
extern size_t count_ampersands();
...
extern void scan_entries();



extern void short_pinky();

extern void long_pinky();
