# 1 "../../../subject/coreutils-6.11/src/fmt.c"
# 1 "/home/seitest_hd2/huwx/workspace/0123_klee_utils_lib_gen/task0401_10-20-40/coreutils_obj_llvm/src//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "../../../subject/coreutils-6.11/src/fmt.c"
# 19 "../../../subject/coreutils-6.11/src/fmt.c"
# 1 "../lib/config.h" 1
# 20 "../../../subject/coreutils-6.11/src/fmt.c" 2
# 1 "../lib/stdio.h" 1
# 1 "../lib/stdio.h"
# 30 "../lib/stdio.h"
...
# 236 "../lib/stdio.h"
  ...
  extern int rpl_vasprintf (char **result, const char *format, va_list args)
    __attribute__ ((__format__ (__printf__, 2, 0)));
# 21 "../../../subject/coreutils-6.11/src/fmt.c" 2
...
# 22 "../../../subject/coreutils-6.11/src/fmt.c" 2
...
extern int getopt_long_only (int ___argc, char *const *___argv,
        const char *__shortopts,
               const struct option *__longopts, int *__longind)
       __attribute__ ((__nothrow__ ));
# 23 "../../../subject/coreutils-6.11/src/fmt.c" 2
...
# 29 "../../../subject/coreutils-6.11/src/fmt.c" 2
...
# 32 "../../../subject/coreutils-6.11/src/fmt.c" 2
# 63 "../../../subject/coreutils-6.11/src/fmt.c"
typedef long int COST;
# 128 "../../../subject/coreutils-6.11/src/fmt.c"
...
# 253 "../../../subject/coreutils-6.11/src/fmt.c"
...
usage (int status)
{
  if (status != 0)
    ...
    {
      printf (((const char *) ("Usage: %s [-DIGITS] [OPTION]... [FILE]...\n")), program_name);
      fputs_unlocked (((const char *) ("Reformat each paragraph in the FILE(s), writing to standard output.\nIf no FILE or if FILE is `-', read standard input.\n\n")),stdout);
      ...
      fputs_unlocked (((const char *) ("  -c, --crown-margin        preserve indentation of first two lines\n  -p, --prefix=STRING       reformat only lines beginning with STRING,\n                              reattaching the prefix to reformatted lines\n  -s, --split-only          split long lines, but do not refill\n")),stdout);
      ...
      fputs_unlocked (((const char *) ("  -t, --tagged-paragraph    indentation of first line different from second\n  -u, --uniform-spacing     one space between words, two after sentences\n  -w, --width=WIDTH         maximum line width (default of 75 columns)\n")),stdout);
...
main (int argc, char **argv)
{
 ...
 if (((unsigned int) (optchar) - '0' <= 9))
   error (0, 0, ((const char *) ("invalid option -- %c; -WIDTH is recognized only when it is the first\noption; use -w N instead")),
 ...
 break;
      ...
      case GETOPT_VERSION_CHAR: version_etc (stdout, "fmt", "GNU coreutils", "6.11", "Ross Paterson", (char *) ((void *)0)); exit (0); break;;
  ...
  if (max_width_option)
    {
      ...
      if (! (xstrtoul (max_width_option, ((void *)0), 10, &tmp, "") == LONGINT_OK
      && tmp <= 5000 / 2))
 error (1, 0, ((const char *) ("invalid width: %s")),
        quote (max_width_option));
      max_width = tmp;
    }

  best_width = max_width * (2 * (100 - 7) + 1) / 200;
      ...
      for (; optind < argc; optind++)
 {
  ...
  {
    error (0, (*__errno_location ()), ((const char *) ("cannot open %s for reading")),
    quote (file));
    ok = 0;
  }
     }
...
# 527 "../../../subject/coreutils-6.11/src/fmt.c"
static _Bool
...
# 647 "../../../subject/coreutils-6.11/src/fmt.c"
static int
...
flush_paragraph (void)
{
  ...
  best_break = ((COST) (! (! ((COST) 0 < (COST) -1)) ? (COST) -1 : ~ (~ (COST) 0 << (sizeof (COST) * 8 - 1))));
      ...
      if (w->best_cost - w->next_break->best_cost < best_break)
 {
   ...
   best_break = w->best_cost - w->next_break->best_cost;
      ...
      if (best_break <= ((COST) (! (! ((COST) 0 < (COST) -1)) ? (COST) -1 : ~ (~ (COST) 0 << (sizeof (COST) * 8 - 1)))) - (((COST) (3)) * ((COST) (3))))
...
fmt_paragraph (void)
{
  ...
  for (start = word_limit - 1; start >= unused_word_type; start--)
    {
      best = ((COST) (! (! ((COST) 0 < (COST) -1)) ? (COST) -1 : ~ (~ (COST) 0 << (sizeof (COST) * 8 - 1))));
