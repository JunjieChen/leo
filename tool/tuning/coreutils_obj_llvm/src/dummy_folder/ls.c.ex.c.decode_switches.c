...
extern strtol_error xstrtoul();
extern void xstrtol_fatal();
extern void * xmalloc();


extern void version_etc();
extern void usage();

extern const enum time_type time_types[5];
extern enum time_type time_type;
extern const enum time_style time_style_types[4];

extern const char *const time_style_args[5];



extern const char *const time_args[6];
...
extern const enum sort_type sort_types[5];

extern enum sort_type sort_type;


extern _Bool sort_reverse;



extern const char *const sort_args[6];

extern void set_quoting_style();
extern int set_char_quoting();
extern _Bool recursive;
extern const enum quoting_style quoting_style_vals[];
extern const char *const quoting_style_args[];
extern char * quotearg();
extern const char * quote();
extern _Bool qmark_funny_chars;

extern _Bool print_with_color;
extern _Bool print_scontext;
extern _Bool print_owner;
extern _Bool print_inode;
extern _Bool print_group;
extern _Bool print_block_size;
extern _Bool print_author;
...
extern const struct option long_options[42];
...
extern int isatty();
extern int ioctl();
extern const enum indicator_style indicator_style_types[4];
extern const char *const indicator_style_args[5];
extern enum indicator_style indicator_style;
extern _Bool immediate_dirs;
extern struct ignore_pattern * ignore_patterns;
extern  enum
{
...
extern enum strtol_error human_options();




extern struct ignore_pattern * hide_patterns;

extern _Bool hard_locale();
extern int getopt_long();
extern char * getenv();
extern enum quoting_style get_quoting_style();

extern const enum format format_types[7];
extern const char *const format_args[8];
...
extern struct quoting_options * dirname_quoting_options;
extern _Bool dired;
extern _Bool directories_first;
extern enum Dereference_symlink dereference;
extern const enum color_type color_types[9];

extern const char *const color_args[10];

extern struct quoting_options * clone_quoting_options();




extern argmatch_exit_fn argmatch_die;
extern ptrdiff_t argmatch();

extern void add_ignore_pattern();
extern void abort();
extern ptrdiff_t __xargmatch_internal();
