...
extern _Bool use_col_separator;
extern int ungetc();
extern _Bool truncate_lines;
extern _Bool storing_columns;
extern void store_char();
extern int spaces_not_printed;
extern int separators_not_printed;

extern void print_sep_string();
extern void print_header();
extern void print_clump();
extern _Bool print_a_header;
extern _Bool print_a_FF;
extern _Bool parallel_files;
extern int padding_not_printed;
extern _Bool pad_vertically;
extern void pad_across_to();


extern _Bool keep_FF;


extern int input_position;
extern void hold_file();
extern int getc_unlocked();
extern _Bool empty_line;
extern COLUMN * column_vector;
extern int col_sep_length;
extern char * clump_buff;
extern void close_file();
extern int chars_per_column;

extern int char_to_clump();

extern _Bool align_empty_cols;
extern void align_column();
extern void add_line_number();
extern _Bool FF_only;
 _Bool
read_line (COLUMN *p)
{
  int c;
