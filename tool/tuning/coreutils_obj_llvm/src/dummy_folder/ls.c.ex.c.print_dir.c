...
extern struct obstack subdired_obstack;
...
extern _Bool print_dir_name;
extern void print_current_files();
...
extern uintmax_t gobble_file();
extern int fstat();
extern int fputs_unlocked();
extern enum format format;

extern _Bool file_ignored();
extern void file_failure();


extern void extract_dirs_from_files();
extern void error();
...
extern Hash_table * active_dir_set;
