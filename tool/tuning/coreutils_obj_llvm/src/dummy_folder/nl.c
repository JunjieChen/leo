# 1 "../../../subject/coreutils-6.11/src/nl.c"
# 1 "/home/seitest_hd2/huwx/workspace/0123_klee_utils_lib_gen/SMO-40-50/coreutils_obj_llvm/src//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "../../../subject/coreutils-6.11/src/nl.c"
# 20 "../../../subject/coreutils-6.11/src/nl.c"
# 1 "../lib/config.h" 1
# 21 "../../../subject/coreutils-6.11/src/nl.c" 2
...
# 236 "../lib/stdio.h"
  ...
  extern int rpl_vasprintf (char **result, const char *format, va_list args)
    __attribute__ ((__format__ (__printf__, 2, 0)));
# 23 "../../../subject/coreutils-6.11/src/nl.c" 2
...
# 24 "../../../subject/coreutils-6.11/src/nl.c" 2
...
extern int getopt_long_only (int ___argc, char *const *___argv,
        const char *__shortopts,
               const struct option *__longopts, int *__longind)
       __attribute__ ((__nothrow__ ));
# 25 "../../../subject/coreutils-6.11/src/nl.c" 2
...
# 27 "../../../subject/coreutils-6.11/src/nl.c" 2

# 1 "../../../subject/coreutils-6.11/lib/regex.h" 1
# 1 "../../../subject/coreutils-6.11/lib/regex.h"
# 56 "../../../subject/coreutils-6.11/lib/regex.h"
...
# 86 "../../../subject/coreutils-6.11/lib/regex.h"
...
# 235 "../../../subject/coreutils-6.11/lib/regex.h"
extern reg_syntax_t rpl_re_syntax_options;
# 372 "../../../subject/coreutils-6.11/lib/regex.h"
typedef enum
{
  _REG_ENOSYS = -1,
  _REG_NOERROR = 0,
...
# 450 "../../../subject/coreutils-6.11/lib/regex.h"
...
# 495 "../../../subject/coreutils-6.11/lib/regex.h"
...
# 541 "../../../subject/coreutils-6.11/lib/regex.h"
typedef struct
{
  regoff_t rm_so;
  regoff_t rm_eo;
...
extern regoff_t rpl_re_match_2 (struct re_pattern_buffer *__buffer,
       ...
       __re_idx_t __start, struct re_registers *__regs,
       __re_idx_t __stop);
# 614 "../../../subject/coreutils-6.11/lib/regex.h"
extern void rpl_re_set_registers (struct re_pattern_buffer *__buffer,
         struct re_registers *__regs,
         __re_size_t __num_regs,
         regoff_t *__starts, regoff_t *__ends);
# 656 "../../../subject/coreutils-6.11/lib/regex.h"
...
# 29 "../../../subject/coreutils-6.11/src/nl.c" 2
...
# 31 "../../../subject/coreutils-6.11/src/nl.c" 2
...
# 34 "../../../subject/coreutils-6.11/src/nl.c" 2
# 44 "../../../subject/coreutils-6.11/src/nl.c"
  ...
  if (status != 0)
  ...
  else
    {
      printf (((const char *) ("Usage: %s [OPTION]... [FILE]...\n")),
       ...
       program_name);
      fputs_unlocked (((const char *) ("Write each FILE to standard output, with line numbers added.\nWith no FILE, or when FILE is -, read standard input.\n\n")),stdout);
      ...
      fputs_unlocked (((const char *) ("  -b, --body-numbering=STYLE      use STYLE for numbering body lines\n  -d, --section-delimiter=CC      use CC for separating logical pages\n  -f, --footer-numbering=STYLE    use STYLE for numbering footer lines\n")),stdout);




      fputs_unlocked (((const char *) ("  -h, --header-numbering=STYLE    use STYLE for numbering header lines\n  -i, --page-increment=NUMBER     line number increment at each line\n  -l, --join-blank-lines=NUMBER   group of NUMBER empty lines counted as one\n  -n, --number-format=FORMAT      insert line numbers according to FORMAT\n  -p, --no-renumber               do not reset line numbers at logical pages\n  -s, --number-separator=STRING   add STRING after (possible) line number\n")),stdout);
      ...
      fputs_unlocked (((const char *) ("  -v, --first-page=NUMBER         first line number on each logical page\n  -w, --number-width=NUMBER       use NUMBER columns for line numbers\n")),stdout);
...
# 228 "../../../subject/coreutils-6.11/src/nl.c"
...
print_lineno (void)
{
  ...
  if (next_line_no < line_no)
    error (1, 0, ((const char *) ("line number overflow")));
...
proc_text (void)
{
 ...
 {
 case -2:
   error (1, (*__errno_location ()), ((const char *) ("error in regular expression search")));
...
main (int argc, char **argv)
{
 ...
 case 'h':
   if (! build_type_arg (&header_type, &header_regex, header_fastmap))
     {
       error (0, 0, ((const char *) ("invalid header numbering style: %s")),
       quote (optarg));
       ok = 0;
     }
   break;
 case 'b':
   if (! build_type_arg (&body_type, &body_regex, body_fastmap))
     {
       error (0, 0, ((const char *) ("invalid body numbering style: %s")),
       quote (optarg));
       ok = 0;
     }
   break;
 case 'f':
   if (! build_type_arg (&footer_type, &footer_regex, footer_fastmap))
     {
       error (0, 0, ((const char *) ("invalid footer numbering style: %s")),
       quote (optarg));
       ok = 0;
     }
   break;
 case 'v':
   if (xstrtoimax (optarg, ((void *)0), 10, &starting_line_number, "")
       != LONGINT_OK)
     {
       error (0, 0, ((const char *) ("invalid starting line number: %s")),
       quote (optarg));
       ok = 0;
     }
   break;
 case 'i':
   if (! (xstrtoimax (optarg, ((void *)0), 10, &page_incr, "") == LONGINT_OK
   && 0 < page_incr))
     {
       error (0, 0, ((const char *) ("invalid line number increment: %s")),
       quote (optarg));
       ok = 0;
     }
   break;
 case 'p':
   ...
   break;
 case 'l':
   if (! (xstrtoimax (optarg, ((void *)0), 10, &blank_join, "") == LONGINT_OK
   && 0 < blank_join))
     {
       error (0, 0, ((const char *) ("invalid number of blank lines: %s")),
       quote (optarg));
       ok = 0;
     }
   break;
 ...
 case 'w':
  ...
  || tmp_long <= 0 || tmp_long > 2147483647)
       {
  error (0, 0, ((const char *) ("invalid line number field width: %s")),
         quote (optarg));
  ok = 0;
       }
     else
 ...
 case 'n':
   if ((strcmp (optarg, "ln") == 0))
     ...
     {
       error (0, 0, ((const char *) ("invalid line numbering format: %s")),
       quote (optarg));
       ok = 0;
     }
   break;
 ...
 case GETOPT_VERSION_CHAR: version_etc (stdout, "nl", "GNU coreutils", "6.11", "Scott Bartram", "David MacKenzie", (char *) ((void *)0)); exit (0); break;;
 default:
   ok = 0;
   break;
 }
