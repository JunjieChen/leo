...
void xstrtol_fatal (enum strtol_error,
 ...
 char const FORMAT_RIGHT_NOLZ[] = "%*" "l" "d" "%s";


 char const FORMAT_RIGHT_LZ[] = "%0*" "l" "d" "%s";


 char const FORMAT_LEFT[] = "%-*" "l" "d" "%s";


 char const DEFAULT_SECTION_DELIMITERS[] = "\\:";
...
char *program_name;
 ...
 char const *body_type = "t";


 char const *header_type = "n";


 char const *footer_type = "n";


 char const *current_type;
 ...
 char body_fastmap[(127 * 2 + 1) + 1];
 char header_fastmap[(127 * 2 + 1) + 1];
 char footer_fastmap[(127 * 2 + 1) + 1];


 struct re_pattern_buffer *current_regex = ((void *)0);


 char const *separator_str = "\t";


 char const *section_del = DEFAULT_SECTION_DELIMITERS;


 char *header_del = ((void *)0);


 size_t header_del_len;


 char *body_del = ((void *)0);


 size_t body_del_len;


 char *footer_del = ((void *)0);
 ...
 char *print_no_line_fmt = ((void *)0);


 intmax_t starting_line_number = 1;


 intmax_t page_incr = 1;


 _Bool reset_numbers = 1;


 intmax_t blank_join = 1;


 int lineno_width = 6;


 char const *lineno_format = FORMAT_RIGHT_NOLZ;
...
extern _Bool build_type_arg();



extern void print_lineno();
...
extern void proc_footer();



extern void proc_text();



extern enum section check_section();
