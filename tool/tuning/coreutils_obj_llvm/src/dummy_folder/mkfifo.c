# 1 "../../../subject/coreutils-6.11/src/mkfifo.c"
# 1 "/home/seitest_hd2/huwx/workspace/0123_klee_utils_lib_gen/task0401_10-20-40/coreutils_obj_llvm/src//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "../../../subject/coreutils-6.11/src/mkfifo.c"
# 19 "../../../subject/coreutils-6.11/src/mkfifo.c"
# 1 "../lib/config.h" 1
# 20 "../../../subject/coreutils-6.11/src/mkfifo.c" 2
# 1 "../lib/stdio.h" 1
# 1 "../lib/stdio.h"
# 30 "../lib/stdio.h"
...
# 236 "../lib/stdio.h"
  ...
  extern int rpl_vasprintf (char **result, const char *format, va_list args)
    __attribute__ ((__format__ (__printf__, 2, 0)));
# 21 "../../../subject/coreutils-6.11/src/mkfifo.c" 2
...
extern int getopt_long_only (int ___argc, char *const *___argv,
        const char *__shortopts,
               const struct option *__longopts, int *__longind)
       __attribute__ ((__nothrow__ ));
# 22 "../../../subject/coreutils-6.11/src/mkfifo.c" 2
...
# 23 "../../../subject/coreutils-6.11/src/mkfifo.c" 2
...
# 24 "../../../subject/coreutils-6.11/src/mkfifo.c" 2
...
# 26 "../../../subject/coreutils-6.11/src/mkfifo.c" 2
...
# 27 "../../../subject/coreutils-6.11/src/mkfifo.c" 2
...
usage (int status)
{
  if (status != 0)
  ...
  else
    {
      ...
      fputs_unlocked (((const char *) ("Create named pipes (FIFOs) with the given NAMEs.\n\n")),stdout);



      fputs_unlocked (((const char *) ("  -Z, --context=CTX  set the SELinux security context of each NAME to CTX\n")),stdout);
 ...
 error (1, 0,
  ...
  for (; optind < argc; ++optind)
    if (mkfifo (argv[optind], newmode) != 0)
      {
 error (0, (*__errno_location ()), ((const char *) ("cannot create fifo %s")), quote (argv[optind]));
 exit_status = 1;
      }
