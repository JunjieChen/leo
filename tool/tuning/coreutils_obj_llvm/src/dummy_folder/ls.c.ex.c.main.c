...
extern long get_stat_atime_ns();


extern long get_stat_ctime_ns();


extern long get_stat_mtime_ns();


extern long get_stat_birthtime_ns();


extern struct timespec get_stat_atime();


extern struct timespec get_stat_ctime();


extern struct timespec get_stat_mtime();



extern struct timespec get_stat_birthtime();
...
enum filetype
 ...
 char const filetype_letter[] = "?pcdb-lswd";
...
enum time_style
 ...
 char const *const time_style_args[] =
{
  "full-iso", "long-iso", "iso", "locale", ((void *)0)
};
 enum time_style const time_style_types[] =
{
...
struct color_ext_type
 ...
 struct color_ext_type *color_ext_list = ((void *)0);
...
struct ignore_pattern
 ...
 struct quoting_options *filename_quoting_options;
...
enum { TIME_STAMP_LEN_MAXIMUM = (((1000)>(((sizeof (time_t) * 8 - (! ((__typeof__ (time_t)) 0 < (__typeof__ (time_t)) -1))) * 146 / 485 + (! ((__typeof__ (time_t)) 0 < (__typeof__ (time_t)) -1)) + 1)))?(1000):(((sizeof (time_t) * 8 - (! ((__typeof__ (time_t)) 0 < (__typeof__ (time_t)) -1))) * 146 / 485 + (! ((__typeof__ (time_t)) 0 < (__typeof__ (time_t)) -1)) + 1))) };
 ...
 sig_atomic_t volatile stop_signal_count;
 ...
 char const *const format_args[] =
{
 ...
 enum format const format_types[] =
{
 ...
 char const *const sort_args[] =
{
 ...
 enum sort_type const sort_types[] =
{
...
extern int (* verify_function__ (void)) [(!!sizeof (struct { unsigned int verify_error_if_negative_size__: ((sizeof (sort_args) / sizeof *(sort_args)) == (sizeof (sort_types) / sizeof *(sort_types)) + 1) ? 1 : -1; }))];
 ...
 char const *const time_args[] =
{
  "atime", "access", "use", "ctime", "status", ((void *)0)
};
 enum time_type const time_types[] =
{
...
struct column_info
{
 ...
 struct obstack subdired_obstack;
 struct obstack dev_ino_obstack;
extern struct dev_ino dev_ino_pop();
extern void dired_dump_obstack();

extern size_t dev_ino_hash();

extern _Bool dev_ino_compare();

extern void dev_ino_free();





extern _Bool visit_dir();

extern void free_pending_ent();

extern _Bool is_colored();

extern void restore_default_color();
...
extern void set_exit_status();





extern void file_failure();
...
extern uintmax_t unsigned_file_size();
...
extern _Bool basename_is_dot_or_dotdot();
...
extern int cmp_ctime();

extern int cmp_mtime();

extern int cmp_atime();
...
extern int cmp_extension();

extern int xstrcoll_ctime(); extern int strcmp_ctime(); extern int rev_xstrcoll_ctime(); extern int rev_strcmp_ctime(); extern int xstrcoll_df_ctime(); extern int strcmp_df_ctime(); extern int rev_xstrcoll_df_ctime(); extern int rev_strcmp_df_ctime();
extern int xstrcoll_mtime(); extern int strcmp_mtime(); extern int rev_xstrcoll_mtime(); extern int rev_strcmp_mtime(); extern int xstrcoll_df_mtime(); extern int strcmp_df_mtime(); extern int rev_xstrcoll_df_mtime(); extern int rev_strcmp_df_mtime();
extern int xstrcoll_atime(); extern int strcmp_atime(); extern int rev_xstrcoll_atime(); extern int rev_strcmp_atime(); extern int xstrcoll_df_atime(); extern int strcmp_df_atime(); extern int rev_xstrcoll_df_atime(); extern int rev_strcmp_df_atime();
extern int xstrcoll_size(); extern int strcmp_size(); extern int rev_xstrcoll_size(); extern int rev_strcmp_size(); extern int xstrcoll_df_size(); extern int strcmp_df_size(); extern int rev_xstrcoll_df_size(); extern int rev_strcmp_df_size();
extern int xstrcoll_name(); extern int strcmp_name(); extern int rev_xstrcoll_name(); extern int rev_strcmp_name(); extern int xstrcoll_df_name(); extern int strcmp_df_name(); extern int rev_xstrcoll_df_name(); extern int rev_strcmp_df_name();
extern int xstrcoll_extension(); extern int strcmp_extension(); extern int rev_xstrcoll_extension(); extern int rev_strcmp_extension(); extern int xstrcoll_df_extension(); extern int strcmp_df_extension(); extern int rev_xstrcoll_df_extension(); extern int rev_strcmp_df_extension();
extern int cmp_version();

extern int xstrcoll_version();
extern int rev_xstrcoll_version();
extern int xstrcoll_df_version();
extern int rev_xstrcoll_df_version();
...
extern void initialize_ordering_vector();
...
extern int long_time_expected_width();




extern void format_user_or_group();




extern void format_user();



extern void format_group();



extern int format_user_or_group_width();
...
extern char get_type_indicator();
...
extern size_t length_of_file_name_and_frills();
