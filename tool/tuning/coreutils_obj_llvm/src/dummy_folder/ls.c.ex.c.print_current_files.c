...
extern void print_with_commas();
extern void print_many_per_line();
extern void print_long_format();
extern void print_horizontal();
extern void print_file_name_and_frills();
