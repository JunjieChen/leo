...
extern enum RM_status remove_cwd_entries();
extern const char * quote_n();
extern const char * quote();
extern enum RM_status prompt();
extern int printf();
extern void longjmp();

extern _Bool ignorable_missing();
extern char * full_filename_();
extern void free();
extern DIR * fdopendir();
extern DIR * fd_to_subdirp();
...
extern int closedir();
extern int close();
extern struct stat * cache_stat_init();
...
extern struct AD_ent * AD_stack_top();
extern void AD_stack_pop();
extern size_t AD_stack_height();
extern void AD_push();
extern char * AD_pop_and_chdir();
extern void AD_mark_current_as_unremovable();
extern void AD_mark_as_unremovable();
 enum RM_status
