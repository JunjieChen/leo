# 1 "../../../subject/coreutils-6.11/src/join.c"
# 1 "/home/seitest_hd2/huwx/workspace/0123_klee_utils_lib_gen/task0401_10-20-40/coreutils_obj_llvm/src//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "../../../subject/coreutils-6.11/src/join.c"
# 19 "../../../subject/coreutils-6.11/src/join.c"
# 1 "../lib/config.h" 1
# 20 "../../../subject/coreutils-6.11/src/join.c" 2
...
# 22 "../../../subject/coreutils-6.11/src/join.c" 2
...
# 23 "../../../subject/coreutils-6.11/src/join.c" 2
...
extern int getopt_long_only (int ___argc, char *const *___argv,
        const char *__shortopts,
               const struct option *__longopts, int *__longind)
       __attribute__ ((__nothrow__ ));
# 24 "../../../subject/coreutils-6.11/src/join.c" 2
...
# 26 "../../../subject/coreutils-6.11/src/join.c" 2
...
# 27 "../../../subject/coreutils-6.11/src/join.c" 2
# 1 "../../../subject/coreutils-6.11/lib/hard-locale.h" 1
# 23 "../../../subject/coreutils-6.11/lib/hard-locale.h"
_Bool hard_locale (int);
# 28 "../../../subject/coreutils-6.11/src/join.c" 2
# 1 "../../../subject/coreutils-6.11/lib/linebuffer.h" 1
# 22 "../../../subject/coreutils-6.11/lib/linebuffer.h"
# 1 "../lib/stdio.h" 1
# 1 "../lib/stdio.h"
# 23 "../../../subject/coreutils-6.11/lib/linebuffer.h" 2
...
# 29 "../../../subject/coreutils-6.11/src/join.c" 2
# 1 "../../../subject/coreutils-6.11/lib/memcasecmp.h" 1
# 20 "../../../subject/coreutils-6.11/lib/memcasecmp.h"
# 1 "/home/seitest_hd2/huwx/tool/llvm/prebuild/llvm-gcc-4.2/bin/../lib/gcc/x86_64-unknown-linux-gnu/4.2.1/include/stddef.h" 1 3 4
# 21 "../../../subject/coreutils-6.11/lib/memcasecmp.h" 2

int memcasecmp (const void *vs1, const void *vs2, size_t n);
# 30 "../../../subject/coreutils-6.11/src/join.c" 2
# 1 "../../../subject/coreutils-6.11/lib/quote.h" 1
# 20 "../../../subject/coreutils-6.11/lib/quote.h"
char const *quote_n (int n, char const *name);
char const *quote (char const *name);
# 31 "../../../subject/coreutils-6.11/src/join.c" 2
# 1 "../../../subject/coreutils-6.11/lib/stdio--.h" 1
# 20 "../../../subject/coreutils-6.11/lib/stdio--.h"
# 1 "../lib/stdio.h" 1
# 1 "../lib/stdio.h"
# 21 "../../../subject/coreutils-6.11/lib/stdio--.h" 2
# 1 "../../../subject/coreutils-6.11/lib/stdio-safer.h" 1
# 20 "../../../subject/coreutils-6.11/lib/stdio-safer.h"
# 1 "../lib/stdio.h" 1
# 1 "../lib/stdio.h"
# 21 "../../../subject/coreutils-6.11/lib/stdio-safer.h" 2

FILE *fopen_safer (char const *, char const *);
FILE *tmpfile_safer (void);
# 22 "../../../subject/coreutils-6.11/lib/stdio--.h" 2
# 32 "../../../subject/coreutils-6.11/src/join.c" 2
# 1 "../../../subject/coreutils-6.11/lib/xmemcoll.h" 1
# 1 "/home/seitest_hd2/huwx/tool/llvm/prebuild/llvm-gcc-4.2/bin/../lib/gcc/x86_64-unknown-linux-gnu/4.2.1/include/stddef.h" 1 3 4
# 2 "../../../subject/coreutils-6.11/lib/xmemcoll.h" 2
int xmemcoll (char *, size_t, char *, size_t);
# 33 "../../../subject/coreutils-6.11/src/join.c" 2
...
# 34 "../../../subject/coreutils-6.11/src/join.c" 2
...
char const *argmatch_to_argument (char const *value,
      ...
      char const *vallist, size_t valsize);
# 35 "../../../subject/coreutils-6.11/src/join.c" 2
# 45 "../../../subject/coreutils-6.11/src/join.c"
struct outlist
  {
...
usage (int status)
{
  if (status != 0)
    ...
    {
      printf (((const char *) ("Usage: %s [OPTION]... FILE1 FILE2\n")),


       program_name);
      fputs_unlocked (((const char *) ("For each pair of input lines with identical join fields, write a line to\nstandard output.  The default join field is the first, delimited\nby whitespace.  When FILE1 or FILE2 (not both) is -, read standard input.\n\n  -a FILENUM        print unpairable lines coming from file FILENUM, where\n                      FILENUM is 1 or 2, corresponding to FILE1 or FILE2\n  -e EMPTY          replace missing input fields with EMPTY\n")),stdout);
# 173 "../../../subject/coreutils-6.11/src/join.c"
      fputs_unlocked (((const char *) ("  -i, --ignore-case  ignore differences in case when comparing fields\n  -j FIELD          equivalent to `-1 FIELD -2 FIELD'\n  -o FORMAT         obey FORMAT while constructing output line\n  -t CHAR           use CHAR as input and output field separator\n")),stdout);





      fputs_unlocked (((const char *) ("  -v FILENUM        like -a FILENUM, but suppress joined output lines\n  -1 FIELD          join on this FIELD of file 1\n  -2 FIELD          join on this FIELD of file 2\n  --check-order     check that the input is correctly sorted, even\n                      if all input lines are pairable\n  --nocheck-order   do not check that the input is correctly sorted\n")),stdout);
...
# 203 "../../../subject/coreutils-6.11/src/join.c"
...
# 371 "../../../subject/coreutils-6.11/src/join.c"
static void
   ...
   if (keycmp (prev, current, join_field, join_field) > 0)
     {
       error ((check_input_order == CHECK_ORDER_ENABLED
        ? 1 : 0),
       0, ((const char *) ("File %d is not in sorted order")), whatfile);
...
add_field (int file, size_t field)
{
  ...
  ((file == 0 || file == 1 || file == 2) ? (void) (0) : __assert_fail ("file == 0 || file == 1 || file == 2", "../../../subject/coreutils-6.11/src/join.c", 740, __PRETTY_FUNCTION__));
  ((file != 0 || field == 0) ? (void) (0) : __assert_fail ("file != 0 || field == 0", "../../../subject/coreutils-6.11/src/join.c", 741, __PRETTY_FUNCTION__));
...
string_to_join_field (char const *str)
{
  ...
  extern int (* verify_function__ (void)) [(!!sizeof (struct { unsigned int verify_error_if_negative_size__: ((18446744073709551615UL) <= (9223372036854775807L * 2UL + 1UL)) ? 1 : -1; }))];
  ...
  if (s_err == LONGINT_OVERFLOW || (s_err == LONGINT_OK && (18446744073709551615UL) < val))
    ...
    error (1, 0, ((const char *) ("invalid field number: %s")), quote (str));
...
decode_field_spec (const char *s, int *file_index, size_t *field_index)
{
  ...
  switch (s[0])
   ...
   error (1, 0, ((const char *) ("invalid field specifier: %s")), quote (s));
 }
      *file_index = 0;
      *field_index = 0;
      break;
 ...
 error (1, 0, ((const char *) ("invalid field specifier: %s")), quote (s));
    ...
    default:
      error (1, 0,
      ((const char *) ("invalid file number in field spec: %s")), quote (s));
  ...
  if (*var != (18446744073709551615UL) && *var != val)
    {
      ...
      error (1, 0, ((const char *) ("incompatible join fields %lu, %lu")),
      var1, val1);
    }
  *var = val;
}
        ...
        int *prev_optc_status, int *optc_status)
{
 ...
 case MUST_BE_OPERAND:
   error (0, 0, ((const char *) ("extra operand %s")), quote (name));
   usage (1);
...
main (int argc, char **argv)
{
 ...
 case 'a':
  ...
  || (val != 1 && val != 2))
       error (1, 0,
       ((const char *) ("invalid field number: %s")), quote (optarg));
     if (val == 1)
 ...
 case 'e':
   if (empty_filler && ! (strcmp (empty_filler, optarg) == 0))
     error (1, 0,
     ((const char *) ("conflicting empty-field replacement strings")));
   empty_filler = optarg;
   break;
 ...
 case 't':
   {
     ...
     if (! newtab)
       error (1, 0, ((const char *) ("empty tab")));
     if (optarg[1])
       {
  if ((strcmp (optarg, "\\0") == 0))
    newtab = '\0';
  else
    error (1, 0, ((const char *) ("multi-character tab %s")),
    quote (optarg));
       }
     if (0 <= tab && tab != newtab)
