# 1 "../../../subject/coreutils-6.11/src/mv.c"
# 1 "/home/seitest_hd2/huwx/workspace/0123_klee_utils_lib_gen/task0401_10-20-40/coreutils_obj_llvm/src//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "../../../subject/coreutils-6.11/src/mv.c"
# 19 "../../../subject/coreutils-6.11/src/mv.c"
# 1 "../lib/config.h" 1
# 20 "../../../subject/coreutils-6.11/src/mv.c" 2
# 1 "../lib/stdio.h" 1
# 1 "../lib/stdio.h"
# 30 "../lib/stdio.h"
...
# 236 "../lib/stdio.h"
  ...
  extern int rpl_vasprintf (char **result, const char *format, va_list args)
    __attribute__ ((__format__ (__printf__, 2, 0)));
# 21 "../../../subject/coreutils-6.11/src/mv.c" 2
...
extern int getopt_long_only (int ___argc, char *const *___argv,
        const char *__shortopts,
               const struct option *__longopts, int *__longind)
       __attribute__ ((__nothrow__ ));
# 22 "../../../subject/coreutils-6.11/src/mv.c" 2
...
# 23 "../../../subject/coreutils-6.11/src/mv.c" 2
...
# 24 "../../../subject/coreutils-6.11/src/mv.c" 2
...
# 25 "../../../subject/coreutils-6.11/src/mv.c" 2
...
# 27 "../../../subject/coreutils-6.11/src/mv.c" 2
...
char const *argmatch_to_argument (char const *value,
      ...
      char const *vallist, size_t valsize);
# 28 "../../../subject/coreutils-6.11/src/mv.c" 2
...
# 29 "../../../subject/coreutils-6.11/src/mv.c" 2
...
# 30 "../../../subject/coreutils-6.11/src/mv.c" 2
...
# 31 "../../../subject/coreutils-6.11/src/mv.c" 2
...
# 32 "../../../subject/coreutils-6.11/src/mv.c" 2
...
char *mfile_name_concat (char const *dir, char const *base,
    char **base_in_result);
# 33 "../../../subject/coreutils-6.11/src/mv.c" 2
# 1 "../../../subject/coreutils-6.11/lib/quote.h" 1
# 20 "../../../subject/coreutils-6.11/lib/quote.h"
char const *quote_n (int n, char const *name);
char const *quote (char const *name);
# 34 "../../../subject/coreutils-6.11/src/mv.c" 2
# 1 "../../../subject/coreutils-6.11/src/remove.h" 1
# 22 "../../../subject/coreutils-6.11/src/remove.h"
...
# 23 "../../../subject/coreutils-6.11/src/remove.h" 2
...
# 92 "../../../subject/coreutils-6.11/src/remove.h"
enum RM_status rm (size_t n_files, char const *const *file,
     struct rm_options const *x);
# 35 "../../../subject/coreutils-6.11/src/mv.c" 2
# 1 "../../../subject/coreutils-6.11/lib/root-dev-ino.h" 1
# 21 "../../../subject/coreutils-6.11/lib/root-dev-ino.h"
# 1 "../../../subject/coreutils-6.11/lib/dev-ino.h" 1
# 22 "../../../subject/coreutils-6.11/lib/root-dev-ino.h" 2
# 1 "../../../subject/coreutils-6.11/lib/same-inode.h" 1
# 23 "../../../subject/coreutils-6.11/lib/root-dev-ino.h" 2

struct dev_ino *
get_root_dev_ino (struct dev_ino *root_d_i);
# 36 "../../../subject/coreutils-6.11/src/mv.c" 2
# 50 "../../../subject/coreutils-6.11/src/mv.c"
enum
{
  REPLY_OPTION = 127 + 1,
...
rm_option_init (struct rm_options *x)
{
...

  {
    ...
    if (x->root_dev_ino == ((void *)0))
      error (1, (*__errno_location ()), ((const char *) ("failed to get attributes of %s")),
      quote ("/"));
  }
}
...
target_directory_operand (char const *file)
{
  ...
  if (err && err != 2)
    error (1, err, ((const char *) ("accessing %s")), quote (file));
  return is_a_dir;
}
  ...
  if (ok)
    {
      ...
      if (copy_into_self)
 {
# 198 "../../../subject/coreutils-6.11/src/mv.c"
 ...
 {
# 231 "../../../subject/coreutils-6.11/src/mv.c"
      ...
      if (dir_to_remove != ((void *)0))
 {
   ...
   ((((status) == RM_OK || (status) == RM_USER_DECLINED || (status) == RM_ERROR)) ? (void) (0) : __assert_fail ("((status) == RM_OK || (status) == RM_USER_DECLINED || (status) == RM_ERROR)", "../../../subject/coreutils-6.11/src/mv.c", 243, __PRETTY_FUNCTION__));
   if (status == RM_ERROR)
     ok = 0;
 }
    }
...
{
  _Bool ok;
# 269 "../../../subject/coreutils-6.11/src/mv.c"
...
usage (int status)
{
  if (status != 0)
    ...
    {
      printf (((const char *) ("Usage: %s [OPTION]... [-T] SOURCE DEST\n  or:  %s [OPTION]... SOURCE... DIRECTORY\n  or:  %s [OPTION]... -t DIRECTORY SOURCE...\n")),




       program_name, program_name, program_name);
      fputs_unlocked (((const char *) ("Rename SOURCE to DEST, or move SOURCE(s) to DIRECTORY.\n\n")),stdout);
      ...
      fputs_unlocked (((const char *) ("      --backup[=CONTROL]       make a backup of each existing destination file\n  -b                           like --backup but does not accept an argument\n  -f, --force                  do not prompt before overwriting\n  -i, --interactive            prompt before overwrite\n")),stdout);





      fputs_unlocked (((const char *) ("      --strip-trailing-slashes  remove any trailing slashes from each SOURCE\n                                 argument\n  -S, --suffix=SUFFIX          override the usual backup suffix\n")),stdout);




      fputs_unlocked (((const char *) ("  -t, --target-directory=DIRECTORY  move all SOURCE arguments into DIRECTORY\n  -T, --no-target-directory    treat DEST as a normal file\n  -u, --update                 move only when the SOURCE file is newer\n                                 than the destination file or when the\n                                 destination file is missing\n  -v, --verbose                explain what is being done\n")),stdout);
      ...
      fputs_unlocked (((const char *) ("  none, off       never make backups (even if --backup is given)\n  numbered, t     make numbered backups\n  existing, nil   numbered if numbered backups exist, simple otherwise\n  simple, never   always make simple backups\n")),stdout);
...
main (int argc, char **argv)
{
  ...
  while ((c = getopt_long (argc, argv, "bfit:uvS:T", long_options, ((void *)0)))
  != -1)
    {
      switch (c)
 {
 ...
 case REPLY_OPTION:
   ...
   error (0, 0,
   ((const char *) ("the --reply option is deprecated; use -i or -f instead")));
   break;
 ...
 case 't':
   if (target_directory)
     error (1, 0, ((const char *) ("multiple target directories specified")));
   else
     {
       struct stat st;
       if (stat (optarg, &st) != 0)
  error (1, (*__errno_location ()), ((const char *) ("accessing %s")), quote (optarg));
       if (! ((((st.st_mode)) & 0170000) == (0040000)))
  error (1, 0, ((const char *) ("target %s is not a directory")),
         quote (optarg));
     }
 ...
 case GETOPT_VERSION_CHAR: version_etc (stdout, "mv", "GNU coreutils", "6.11", "Mike Parker", "David MacKenzie", "Jim Meyering", (char *) ((void *)0)); exit (0); break;;
 default:
   usage (1);
 }
    }
  ...
  if (n_files <= !target_directory)
    {
      if (n_files <= 0)
 error (0, 0, ((const char *) ("missing file operand")));
      else
 error (0, 0, ((const char *) ("missing destination file operand after %s")),
        quote (file[0]));
      usage (1);
    }
  ...
  if (no_target_directory)
    {
      if (target_directory)
 error (1, 0,
        ((const char *) ("Cannot combine --target-directory (-t) " "and --no-target-directory (-T)")));

      if (2 < n_files)
 {
   error (0, 0, ((const char *) ("extra operand %s")), quote (file[2]));
   usage (1);
 }
    }
  else if (!target_directory)
    {
      ((2 <= n_files) ? (void) (0) : __assert_fail ("2 <= n_files", "../../../subject/coreutils-6.11/src/mv.c", 463, __PRETTY_FUNCTION__));
 ...
 error (1, 0, ((const char *) ("target %s is not a directory")),
  ...
  x.backup_type = (make_backups
     ? xget_version (((const char *) ("backup type")),
