...
char *program_name;
 ...
 struct line *prevline[2];


 _Bool hard_LC_COLLATE;


 _Bool print_unpairables_1, print_unpairables_2;
 ...
 char const *empty_filler;


 size_t join_field_1 = (18446744073709551615UL);
 size_t join_field_2 = (18446744073709551615UL);


 struct outlist outlist_head;


 struct outlist *outlist_end = &outlist_head;
...
extern void extract_field();



extern void xfields();

extern struct line * dup_line();

extern void freeline();
...
extern int keycmp();
extern void check_order();




extern _Bool get_line();

extern void free_prevline();
...
extern void system_join();



extern void add_field();
...
extern size_t string_to_join_field();





extern void decode_field_spec();



extern void add_field_list();




extern void set_join_field();
