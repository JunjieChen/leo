# 1 "../../../subject/coreutils-6.11/src/pinky.c"
# 1 "/home/seitest_hd2/huwx/workspace/0123_klee_utils_lib_gen/SMO-40-50/coreutils_obj_llvm/src//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "../../../subject/coreutils-6.11/src/pinky.c"
# 19 "../../../subject/coreutils-6.11/src/pinky.c"
# 1 "../lib/config.h" 1
# 20 "../../../subject/coreutils-6.11/src/pinky.c" 2
...
extern int getopt_long_only (int ___argc, char *const *___argv,
        const char *__shortopts,
               const struct option *__longopts, int *__longind)
       __attribute__ ((__nothrow__ ));
# 21 "../../../subject/coreutils-6.11/src/pinky.c" 2
...
# 22 "../../../subject/coreutils-6.11/src/pinky.c" 2
# 1 "../lib/stdio.h" 1
# 1 "../lib/stdio.h"
# 30 "../lib/stdio.h"
# 1 "/usr/include/stdio.h" 1 3 4
...
# 236 "../lib/stdio.h"
  ...
  extern int rpl_vasprintf (char **result, const char *format, va_list args)
    __attribute__ ((__format__ (__printf__, 2, 0)));
# 23 "../../../subject/coreutils-6.11/src/pinky.c" 2
...
# 25 "../../../subject/coreutils-6.11/src/pinky.c" 2
...
# 26 "../../../subject/coreutils-6.11/src/pinky.c" 2

# 1 "../../../subject/coreutils-6.11/lib/canon-host.h" 1
# 23 "../../../subject/coreutils-6.11/lib/canon-host.h"
char *canon_host (char const *host);
char *canon_host_r (char const *host, int *cherror);

const char *ch_strerror (void);
# 28 "../../../subject/coreutils-6.11/src/pinky.c" 2
...
# 31 "../../../subject/coreutils-6.11/src/pinky.c" 2
# 1 "../../../subject/coreutils-6.11/lib/readutmp.h" 1
# 35 "../../../subject/coreutils-6.11/lib/readutmp.h"
# 1 "/usr/include/utmp.h" 1 3 4
# 27 "/usr/include/utmp.h" 3 4



# 1 "/usr/include/bits/utmp.h" 1 3 4
# 25 "/usr/include/bits/utmp.h" 3 4
# 1 "/usr/include/paths.h" 1 3 4
# 26 "/usr/include/bits/utmp.h" 2 3 4


# 1 "/usr/include/bits/wordsize.h" 1 3 4
# 29 "/usr/include/bits/utmp.h" 2 3 4
# 38 "/usr/include/bits/utmp.h" 3 4
struct lastlog
  {
...
# 31 "/usr/include/utmp.h" 2 3 4
# 42 "/usr/include/utmp.h" 3 4
extern int login_tty (int __fd) __attribute__ ((__nothrow__ ));



extern void login (__const struct utmp *__entry) __attribute__ ((__nothrow__ ));


extern int logout (__const char *__ut_line) __attribute__ ((__nothrow__ ));


extern void logwtmp (__const char *__ut_line, __const char *__ut_name,
       __const char *__ut_host) __attribute__ ((__nothrow__ ));
...
extern int utmpname (__const char *__file) __attribute__ ((__nothrow__ ));
...
extern struct utmp *getutid (__const struct utmp *__id) __attribute__ ((__nothrow__ ));



extern struct utmp *getutline (__const struct utmp *__line) __attribute__ ((__nothrow__ ));


extern struct utmp *pututline (__const struct utmp *__utmp_ptr) __attribute__ ((__nothrow__ ));
...
# 36 "../../../subject/coreutils-6.11/lib/readutmp.h" 2
...
# 26 "/usr/include/bits/utmpx.h" 3 4
# 1 "/usr/include/bits/wordsize.h" 1 3 4
# 27 "/usr/include/bits/utmpx.h" 2 3 4
# 43 "/usr/include/bits/utmpx.h" 3 4
...
# 43 "../../../subject/coreutils-6.11/lib/readutmp.h" 2
# 144 "../../../subject/coreutils-6.11/lib/readutmp.h"
typedef struct utmpx STRUCT_UTMP;

enum { UT_USER_SIZE = sizeof (((STRUCT_UTMP *) 0)->ut_user) };
# 206 "../../../subject/coreutils-6.11/lib/readutmp.h"
enum
  {
...
int read_utmp (char const *file, size_t *n_entries, STRUCT_UTMP **utmp_buf,
        int options);
# 32 "../../../subject/coreutils-6.11/src/pinky.c" 2
# 42 "../../../subject/coreutils-6.11/src/pinky.c"
char *ttyname ();
...
{
  static time_t now = 0;
  static char buf[((sizeof (long int) * 8 - (! ((__typeof__ (long int)) 0 < (__typeof__ (long int)) -1))) * 146 / 485 + (! ((__typeof__ (long int)) 0 < (__typeof__ (long int)) -1)) + 1) + 2];
  time_t seconds_idle;
...
{
  static char buf[((sizeof (intmax_t) * 8 - (! ((__typeof__ (intmax_t)) 0 < (__typeof__ (intmax_t)) -1))) * 146 / 485 + (! ((__typeof__ (intmax_t)) 0 < (__typeof__ (intmax_t)) -1)) + 1) + sizeof "-%m-%d %H:%M"];
...
print_entry (const STRUCT_UTMP *utmp_ent)
{
  ...
  if (utmp_ent->ut_line[0] == '/')
    ...
    {
      strcpy (line, "/dev/");
      strncpy (line + (sizeof ("/dev/") - 1), utmp_ent->ut_line, sizeof (utmp_ent->ut_line));
      line[(sizeof ("/dev/") - 1) + sizeof (utmp_ent->ut_line)] = '\0';
    }
  ...
  if (include_fullname)
    {
      ...
      strncpy (name, ((utmp_ent)->ut_user), UT_USER_SIZE);
      name[UT_USER_SIZE] = '\0';
      pw = getpwnam (name);
      if (pw == ((void *)0))
 printf (" %19s", "        ???");
...
print_long_entry (const char name[])
{
  ...
  printf (((const char *) ("Login name: ")));
  printf ("%-28s", name);

  printf (((const char *) ("In real life: ")));
  if (pw == ((void *)0))
    {
      printf (" %s", ((const char *) ("???\n")));
      return;
 ...
 *comma = '\0';
  ...
  if (include_home_and_shell)
    {
      printf (((const char *) ("Directory: ")));
      printf ("%-29s", pw->pw_dir);
      printf (((const char *) ("Shell: ")));
...
print_heading (void)
{
  printf ("%-8s", ((const char *) ("Login")));
  if (include_fullname)
    printf (" %-19s", ((const char *) ("Name")));
  printf (" %-9s", ((const char *) (" TTY")));
  if (include_idle)
    printf (" %-6s", ((const char *) ("Idle")));
  printf (" %-*s", time_format_width, ((const char *) ("When")));

  if (include_where)
    printf (" %s", ((const char *) ("Where")));
...
usage (int status)
{
  if (status != 0)
    ...
    {
      printf (((const char *) ("Usage: %s [OPTION]... [USER]...\n")), program_name);
      ...
      fputs_unlocked (((const char *) ("  -f              omit the line of column headings in short format\n  -w              omit the user's full name in short format\n  -i              omit the user's full name and remote host in short format\n  -q              omit the user's full name, remote host and idle time\n                  in short format\n")),stdout);
...
main (int argc, char **argv)
{
 ...
 case GETOPT_VERSION_CHAR: version_etc (stdout, "pinky", "GNU coreutils", "6.11", "Joseph Arceneaux", "David MacKenzie", "Kaveh Ghazi", (char *) ((void *)0)); exit (0); break;;
 ...
 default:
  ...
  if (!do_short_format && n_users == 0)
    {
      error (0, 0, ((const char *) ("no username specified; at least one must be specified when using -l")));
