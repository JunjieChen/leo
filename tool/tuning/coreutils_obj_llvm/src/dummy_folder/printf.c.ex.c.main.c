...
extern void verify_numeric();
extern intmax_t vstrtoimax();
extern uintmax_t vstrtoumax();
extern long double vstrtold();



extern void print_esc_char();
...
extern int print_esc();



extern void print_esc_string();
extern void print_direc();
