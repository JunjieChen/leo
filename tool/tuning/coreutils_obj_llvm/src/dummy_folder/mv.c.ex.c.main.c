...
char *program_name;
 ...
 char const* const reply_args[] =
{
  "yes", "no", "query", ((void *)0)
};


 int const reply_vals[] =
{
...
extern void rm_option_init();

extern void cp_option_init();





extern _Bool target_directory_operand();





extern _Bool do_move();





extern _Bool movefile();
