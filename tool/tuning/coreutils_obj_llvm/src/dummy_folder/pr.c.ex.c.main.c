...
char *program_name;
 ...
 _Bool use_form_feed = 0;


 _Bool have_read_stdin = 0;


 _Bool print_across_flag = 0;


 _Bool storing_columns = 1;





 _Bool balance_columns = 0;
...
enum { lines_per_footer = 5 };
 ...
 _Bool failed_opens = 0;
 int columns = 1;



 uintmax_t first_page_number = 0;
 ...
 _Bool use_esc_sequence = 0;



 _Bool use_cntrl_prefix = 0;


 _Bool double_space = 0;
 ...
 _Bool ignore_failed_opens = 0;



 _Bool use_col_separator = 0;
...
extern int cols_ready_to_print();




extern _Bool first_last_page();





extern void parse_column_count();
