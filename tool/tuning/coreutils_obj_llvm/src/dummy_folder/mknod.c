# 1 "../../../subject/coreutils-6.11/src/mknod.c"
# 1 "/home/seitest_hd2/huwx/workspace/0123_klee_utils_lib_gen/task0401_10-20-40/coreutils_obj_llvm/src//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "../../../subject/coreutils-6.11/src/mknod.c"
# 19 "../../../subject/coreutils-6.11/src/mknod.c"
# 1 "../lib/config.h" 1
# 20 "../../../subject/coreutils-6.11/src/mknod.c" 2
# 1 "../lib/stdio.h" 1
# 1 "../lib/stdio.h"
# 30 "../lib/stdio.h"
...
# 236 "../lib/stdio.h"
  ...
  extern int rpl_vasprintf (char **result, const char *format, va_list args)
    __attribute__ ((__format__ (__printf__, 2, 0)));
# 21 "../../../subject/coreutils-6.11/src/mknod.c" 2
...
extern int getopt_long_only (int ___argc, char *const *___argv,
        const char *__shortopts,
               const struct option *__longopts, int *__longind)
       __attribute__ ((__nothrow__ ));
# 22 "../../../subject/coreutils-6.11/src/mknod.c" 2
...
# 23 "../../../subject/coreutils-6.11/src/mknod.c" 2
...
# 24 "../../../subject/coreutils-6.11/src/mknod.c" 2
...
# 26 "../../../subject/coreutils-6.11/src/mknod.c" 2
...
# 27 "../../../subject/coreutils-6.11/src/mknod.c" 2
...
# 30 "../../../subject/coreutils-6.11/src/mknod.c" 2
...
usage (int status)
{
  if (status != 0)
    ...
    {
      printf (((const char *) ("Usage: %s [OPTION]... NAME TYPE [MAJOR MINOR]\n")),
       program_name);
      fputs_unlocked (((const char *) ("Create the special file NAME of the given TYPE.\n\n")),stdout);



      fputs_unlocked (((const char *) ("  -Z, --context=CTX  set the SELinux security context of NAME to CTX\n")),stdout);


      fputs_unlocked (((const char *) ("Mandatory arguments to long options are mandatory for short options too.\n")),stdout);


      fputs_unlocked (((const char *) ("  -m, --mode=MODE   set file permission bits to MODE, not a=rw - umask\n")),stdout);
...
main (int argc, char **argv)
{
 ...
 fprintf (stderr, "%s\n",
   ((const char *) ("Special files require major and minor device numbers.")));
      usage (1);
    }

  if (expected_operands < argc - optind)
    {
      error (0, 0, ((const char *) ("extra operand %s")),
      quote (argv[optind + expected_operands]));
      if (expected_operands == 2 && argc - optind == 4)
 fprintf (stderr, "%s\n",
   ((const char *) ("Fifos do not have major and minor device numbers.")));
      usage (1);
    }
 ...
 if (xstrtoumax (s_major, ((void *)0), 0, &i_major, ((void *)0)) != LONGINT_OK
   ...
   error (1, 0,
   ((const char *) ("invalid major device number %s")), quote (s_major));

 if (xstrtoumax (s_minor, ((void *)0), 0, &i_minor, ((void *)0)) != LONGINT_OK
     || i_minor != (unsigned int) i_minor)
   error (1, 0,
   ((const char *) ("invalid minor device number %s")), quote (s_minor));
 ...
 error (1, (*__errno_location ()), "%s", quote (argv[optind]));
    ...
    default:
      error (0, 0, ((const char *) ("invalid device type %s")), quote (argv[optind + 1]));
      usage (1);
    }
