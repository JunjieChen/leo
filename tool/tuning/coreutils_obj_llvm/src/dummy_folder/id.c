# 1 "../../../subject/coreutils-6.11/src/id.c"
# 1 "/home/seitest_hd2/huwx/workspace/0123_klee_utils_lib_gen/task0401_10-20-40/coreutils_obj_llvm/src//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "../../../subject/coreutils-6.11/src/id.c"
# 20 "../../../subject/coreutils-6.11/src/id.c"
# 1 "../lib/config.h" 1
# 21 "../../../subject/coreutils-6.11/src/id.c" 2
# 1 "../lib/stdio.h" 1
# 1 "../lib/stdio.h"
# 30 "../lib/stdio.h"
...
# 236 "../lib/stdio.h"
  ...
  extern int rpl_vasprintf (char **result, const char *format, va_list args)
    __attribute__ ((__format__ (__printf__, 2, 0)));
# 22 "../../../subject/coreutils-6.11/src/id.c" 2
...
# 23 "../../../subject/coreutils-6.11/src/id.c" 2
...
# 24 "../../../subject/coreutils-6.11/src/id.c" 2
...
# 25 "../../../subject/coreutils-6.11/src/id.c" 2
...
extern int getopt_long_only (int ___argc, char *const *___argv,
        const char *__shortopts,
               const struct option *__longopts, int *__longind)
       __attribute__ ((__nothrow__ ));
# 26 "../../../subject/coreutils-6.11/src/id.c" 2
...
# 27 "../../../subject/coreutils-6.11/src/id.c" 2
...
# 29 "../../../subject/coreutils-6.11/src/id.c" 2
...
# 30 "../../../subject/coreutils-6.11/src/id.c" 2
# 1 "../../../subject/coreutils-6.11/lib/mgetgroups.h" 1
# 19 "../../../subject/coreutils-6.11/lib/mgetgroups.h"
int mgetgroups (const char *username, gid_t gid, gid_t **groups);
# 31 "../../../subject/coreutils-6.11/src/id.c" 2
# 1 "../../../subject/coreutils-6.11/lib/quote.h" 1
# 20 "../../../subject/coreutils-6.11/lib/quote.h"
char const *quote_n (int n, char const *name);
char const *quote (char const *name);
# 32 "../../../subject/coreutils-6.11/src/id.c" 2
# 1 "../../../subject/coreutils-6.11/src/group-list.h" 1
# 18 "../../../subject/coreutils-6.11/src/group-list.h"
_Bool print_group (gid_t, _Bool);
_Bool print_group_list (const char *, uid_t, gid_t, gid_t, _Bool);
# 33 "../../../subject/coreutils-6.11/src/id.c" 2
...
static security_context_t context = ((void *)0);
...
usage (int status)
{
  if (status != 0)
    ...
    {
      printf (((const char *) ("Usage: %s [OPTION]... [USERNAME]\n")), program_name);
      fputs_unlocked (((const char *) ("Print information for USERNAME, or the current user.\n\n  -a              ignore, for compatibility with other versions\n  -Z, --context   print only the security context of the current user\n  -g, --group     print only the effective group ID\n  -G, --groups    print all group IDs\n  -n, --name      print a name instead of a number, for -ugG\n  -r, --real      print the real ID instead of the effective ID, with -ugG\n  -u, --user      print only the effective user ID\n")),stdout);
# 95 "../../../subject/coreutils-6.11/src/id.c"
...
main (int argc, char **argv)
{
 ...
 case 'a':
   ...
   if (!selinux_enabled)
     error (1, 0,
     ((const char *) ("--context (-Z) works only on an SELinux-enabled kernel")));
          just_context = 1;
          break;
 ...
 default:
  ...
  if (argc - optind == 1 && just_context)
    error (1, 0,
    ((const char *) ("cannot print security context when user specified")));

  if (just_context && !selinux_enabled)
    error (1, 0, ((const char *) ("cannot display context when selinux not enabled or when displaying the id\nof a different user")));
  ...
  if (selinux_enabled)
    {
      if (getcon (&context) && just_context)
        error (1, 0, ((const char *) ("can't get process context")));
    }

  if (just_user + just_group + just_group_list + just_context > 1)
    error (1, 0, ((const char *) ("cannot print \"only\" of more than one choice")));

  if (just_user + just_group + just_group_list == 0 && (use_real | use_name))
    error (1, 0,
    ((const char *) ("cannot print only names or real IDs in default format")));
  ...
  if (argc - optind == 1)
    {
      ...
      if (pwd == ((void *)0))
 error (1, 0, ((const char *) ("%s: No such user")), argv[optind]);
  ...
  if (use_name)
    {
      ...
      if (pwd == ((void *)0))
 {
   error (0, 0, ((const char *) ("cannot find name for user ID %lu")),
...
print_full_info (const char *username)
{
 ...
 if (username)
   {
     error (0, (*__errno_location ()), ((const char *) ("failed to get groups for user %s")),
     quote (username));
   }
 else
   {
     error (0, (*__errno_location ()), ((const char *) ("failed to get groups for the current process")));
   }
 ok = 0;
 return;
      }
    ...
    if (n_groups > 0)
      fputs_unlocked (((const char *) (" groups=")),stdout);
