...
extern void initialize_exit_failure();
...
extern const char * pgettext_aux();


extern const char * npgettext_aux();





extern const char * dcpgettext_expr();
...
extern const char * dcnpgettext_expr();
extern unsigned long select_plural();
...
extern _Bool dot_or_dotdot();


extern const struct dirent * readdir_ignoring_dot_and_dotdot();


extern _Bool is_empty_dir();
...
char *program_name;
 unsigned int const bytes_to_oct_digits[] =
{0, 3, 6, 8, 11, 14, 16, 19, 22, 25, 27, 30, 32, 35, 38, 41, 43};

 unsigned int const bytes_to_signed_dec_digits[] =
{1, 4, 6, 8, 11, 13, 16, 18, 20, 23, 25, 28, 30, 33, 35, 37, 40};

 unsigned int const bytes_to_unsigned_dec_digits[] =
{0, 3, 5, 8, 10, 13, 15, 17, 20, 22, 25, 27, 29, 32, 34, 37, 39};

 unsigned int const bytes_to_hex_digits[] =
 ...
 const char *const charname[33] =
{
 ...
 uintmax_t n_bytes_to_skip = 0;



 _Bool limit_bytes_to_format = 0;
 ...
 _Bool abbreviate_duplicate_blocks = 1;
 ...
 char const *const default_file_list[] = {"-", ((void *)0)};
 ...
 enum size_spec integral_type_size[sizeof (unsigned_long_long_int) + 1];


 enum size_spec fp_type_size[sizeof (LONG_DOUBLE) + 1];

 char const short_options[] = "A:aBbcDdeFfHhIij:LlN:OoS:st:vw::Xx";
...
extern void print_s_char();

extern void print_char();

extern void print_s_short();
...
extern void print_long_double();


extern void dump_hexl_mode_trailer();

extern void print_named_ascii();

extern void print_ascii();
extern _Bool simple_strtoul();
extern _Bool decode_one_format();
extern _Bool open_next_file();
extern _Bool check_and_close();





extern _Bool decode_format_string();
extern _Bool skip();

extern void format_address_none();

extern void format_address_std();

extern void format_address_paren();

extern void format_address_label();
extern void write_block();
extern _Bool read_char();
extern _Bool read_block();
