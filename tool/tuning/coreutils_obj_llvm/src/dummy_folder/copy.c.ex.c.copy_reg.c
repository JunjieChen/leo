...
extern int lstat();
extern __off_t lseek();
extern size_t lcm();

extern int gl_futimens();
extern int getpagesize();
extern int getfscreatecon();
extern struct timespec get_stat_mtime();
extern struct timespec get_stat_atime();
extern size_t full_write();
extern int ftruncate();
extern int fstat();

extern void freecon();
extern void free();
extern int fchmod_or_lchmod();
extern void error();
