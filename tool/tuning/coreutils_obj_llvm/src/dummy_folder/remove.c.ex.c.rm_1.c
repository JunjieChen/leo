...
extern enum RM_status remove_entry();
extern enum RM_status remove_dir();
...
extern void error();
extern void ds_clear();

extern _Bool dot_or_dotdot();
extern void cycle_check_init();

extern struct stat * cache_stat_init();
extern int cache_fstatat();
...
extern void AD_stack_clear();
extern void AD_push_initial();
 enum RM_status
