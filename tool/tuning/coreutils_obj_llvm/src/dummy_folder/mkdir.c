# 1 "../../../subject/coreutils-6.11/src/mkdir.c"
# 1 "/home/seitest_hd2/huwx/workspace/0123_klee_utils_lib_gen/task0401_10-20-40/coreutils_obj_llvm/src//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "../../../subject/coreutils-6.11/src/mkdir.c"
# 19 "../../../subject/coreutils-6.11/src/mkdir.c"
# 1 "../lib/config.h" 1
# 20 "../../../subject/coreutils-6.11/src/mkdir.c" 2
# 1 "../lib/stdio.h" 1
# 1 "../lib/stdio.h"
# 30 "../lib/stdio.h"
...
# 236 "../lib/stdio.h"
  ...
  extern int rpl_vasprintf (char **result, const char *format, va_list args)
    __attribute__ ((__format__ (__printf__, 2, 0)));
# 21 "../../../subject/coreutils-6.11/src/mkdir.c" 2
...
extern int getopt_long_only (int ___argc, char *const *___argv,
        const char *__shortopts,
               const struct option *__longopts, int *__longind)
       __attribute__ ((__nothrow__ ));
# 22 "../../../subject/coreutils-6.11/src/mkdir.c" 2
...
# 23 "../../../subject/coreutils-6.11/src/mkdir.c" 2
...
# 24 "../../../subject/coreutils-6.11/src/mkdir.c" 2
...
# 26 "../../../subject/coreutils-6.11/src/mkdir.c" 2
...
# 27 "../../../subject/coreutils-6.11/src/mkdir.c" 2
# 1 "../../../subject/coreutils-6.11/lib/lchmod.h" 1
# 21 "../../../subject/coreutils-6.11/lib/lchmod.h"
# 1 "../lib/sys/stat.h" 1
# 1 "../lib/sys/stat.h"
# 22 "../../../subject/coreutils-6.11/lib/lchmod.h" 2
# 28 "../../../subject/coreutils-6.11/src/mkdir.c" 2
# 1 "../../../subject/coreutils-6.11/lib/mkdir-p.h" 1
# 24 "../../../subject/coreutils-6.11/lib/mkdir-p.h"
struct savewd;
...
# 29 "../../../subject/coreutils-6.11/src/mkdir.c" 2
# 1 "../../../subject/coreutils-6.11/lib/modechange.h" 1
# 25 "../../../subject/coreutils-6.11/lib/modechange.h"
struct mode_change *mode_compile (const char *);
struct mode_change *mode_create_from_ref (const char *);
mode_t mode_adjust (mode_t, _Bool, mode_t, struct mode_change const *,
      mode_t *);
# 30 "../../../subject/coreutils-6.11/src/mkdir.c" 2
# 1 "../../../subject/coreutils-6.11/src/prog-fprintf.h" 1
# 20 "../../../subject/coreutils-6.11/src/prog-fprintf.h"
# 1 "../lib/stdio.h" 1
# 1 "../lib/stdio.h"
# 21 "../../../subject/coreutils-6.11/src/prog-fprintf.h" 2

extern void prog_fprintf (FILE *fp, char const *fmt, ...);
# 31 "../../../subject/coreutils-6.11/src/mkdir.c" 2
# 1 "../../../subject/coreutils-6.11/lib/quote.h" 1
# 20 "../../../subject/coreutils-6.11/lib/quote.h"
char const *quote_n (int n, char const *name);
char const *quote (char const *name);
# 32 "../../../subject/coreutils-6.11/src/mkdir.c" 2
# 1 "../../../subject/coreutils-6.11/lib/savewd.h" 1
# 28 "../../../subject/coreutils-6.11/lib/savewd.h"
struct savewd
{
...
# 108 "../../../subject/coreutils-6.11/lib/savewd.h"
...
# 144 "../../../subject/coreutils-6.11/lib/savewd.h"
int savewd_process_files (int n_files, char **file,
     int (*act) (char *, struct savewd *, void *),
     void *options);
# 33 "../../../subject/coreutils-6.11/src/mkdir.c" 2
...
usage (int status)
{
  if (status != 0)
    ...
    {
      printf (((const char *) ("Usage: %s [OPTION] DIRECTORY...\n")), program_name);
      fputs_unlocked (((const char *) ("Create the DIRECTORY(ies), if they do not already exist.\n\n")),stdout);
      ...
      fputs_unlocked (((const char *) ("  -m, --mode=MODE   set file mode (as in chmod), not a=rwx - umask\n  -p, --parents     no error if existing, make parent directories as needed\n  -v, --verbose     print a message for each created directory\n  -Z, --context=CTX  set the SELinux security context of each created\n                      directory to CTX\n")),stdout);
...
main (int argc, char **argv)
{
  ...
  int optc;
  security_context_t scontext = ((void *)0);
 ...
 case 'm':
   ...
   break;
 case 'v':
   options.created_directory_format = ((const char *) ("created directory %s"));
   break;
 case 'Z':
   scontext = optarg;
   break;
      ...
      if (specified_mode)
 {
   ...
   if (!change)
     error (1, 0, ((const char *) ("invalid mode %s")),
