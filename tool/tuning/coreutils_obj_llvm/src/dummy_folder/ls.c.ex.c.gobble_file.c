...
extern int gnu_mbswidth();
extern unsigned int gnu_dev_minor();
extern unsigned int gnu_dev_major();
extern int getfilecon();
extern void get_link_name();
extern void free();
extern int format_user_width();
extern _Bool format_needs_type;
extern _Bool format_needs_stat;
extern int format_group_width();
extern enum format format;

extern int file_size_width;
extern uintmax_t file_output_block_size;
extern int file_has_acl();
...
extern size_t cwd_n_alloc;
extern struct fileinfo * cwd_file;

extern _Bool color_symlink_as_referent;

extern _Bool check_symlink_color;
...
extern _Bool any_has_acl;

extern int * __errno_location();

extern void __assert_fail();
extern char UNKNOWN_SECURITY_CONTEXT[2];
